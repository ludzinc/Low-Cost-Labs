...
//  File configFile = SPIFFS.open("/lclconfigBETA.json", "r");
  if (!configFile) {
    ...
    json["mqttServer"].as<String>().toCharArray(mqttServer, 30);
    json["mqttSubscription"].as<String>().toCharArray(mqttSubscription, 30);
    json["mqttPublish"].as<String>().toCharArray(mqttPublish, 30);
...
bool saveConfig() {
  ...
  rootSave["mqttServer"] = mqttServer;
  rootSave["mqttSubscription"] = mqttSubscription;
  rootSave["mqttPublish"] = mqttPublish;
